<?php 
	...
	$camisas = array(
		['name' => 'camisa 01', 'image' => 'uploads/camisaum.jpg', 'price' => '55.9'],
		['name' => 'camisa 02', 'image' => 'uploads/camisadois.jpg', 'price' => '45.9'],
		['name' => 'camisa 03', 'image' => 'uploads/camisatres.jpg', 'price' => '65']
	);
?>
	...
	<nav class="navbar navbar-light bg-danger">
	  <div class="container">
	    <a class="navbar-brand" href="#">
	      <img src="images/logo-store.png" alt="" width="50" height="50" class="d-inline-block align-text-top">
	    </a>
	  </div>
	</nav>
